...
const HabitSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'TimestampWithNote': TimestampWithNoteSchema},
  getId: _habitGetId,
...
int _habitEstimateSize(
  ...
  {
    final offsets = allOffsets[TimestampWithNote]!;
    for (var i = 0; i < object.timestamps.length; i++) {
      final value = object.timestamps[i];
      bytesCount +=
          TimestampWithNoteSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  return bytesCount;
}
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> timestampsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'timestamps',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> timestampsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'timestamps',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> timestampsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> timestampsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> timestampsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryObject on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> timestampsElement(
      FilterQuery<TimestampWithNote> q) {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<TimestampWithNote>, QQueryOperations>
      timestampsProperty() {
    return QueryBuilder.apply(this, (query) {
